                                    ...
                                    <tr>
                                        ...
                                        <?php if ($allPrev == '1' || in_array('2', $payment_gateway)) { ?>
                                            <td class="center">
												...
												<li style="width:20%;"><a class="p_edit tipTop" href="admin/payment_gateway/edit_gateway_form/<?php echo $row->_id; ?>" title="<?php if ($this->lang->line('admin_payment_gateway_edit_details') != '') echo stripslashes($this->lang->line('admin_payment_gateway_edit_details')); else echo 'Edit Details'; ?>"><?php if ($this->lang->line('admin_payment_gateway_edit_details') != '') echo stripslashes($this->lang->line('admin_payment_gateway_edit_details')); else echo 'Edit Details'; ?></a></li>
												<li style="width:70%;"><a class="p_edit tipTop" href="admin/payment_gateway/edit_merchant_account/<?php echo $row->_id; ?>" title="<?php if ($this->lang->line('admin_payment_merchant_account') != '') echo stripslashes($this->lang->line('admin_payment_merchant_account')); else echo 'Merchant Account List'; ?>"><?php if ($this->lang->line('admin_payment_merchant_account') != '') echo stripslashes($this->lang->line('admin_payment_merchant_account')); else echo 'Merchant Account List'; ?></a></li>
												</ul>

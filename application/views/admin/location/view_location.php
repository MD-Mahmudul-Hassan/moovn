...
if(isset($location_details->row()->currency)){
	if($location_details->row()->currency != ''){
		$dcurrencyCode = $location_details->row()->currency;
		$dcurrencySymbol = $location_details->row()->currency_symbol;
	}
}

$d_distance_unit = $d_distance_unit;
$d_distance_unit_name = $d_distance_unit_name;
if(isset($location_details->row()->distance_unit)){
	if($location_details->row()->distance_unit != ''){
		$d_distance_unit = $location_details->row()->distance_unit;
		$d_distance_unit_name = $location_details->row()->distance_unit_name;
	}
}
?>
<style>
				...
				<div class="widget_content">
					...
					<div id="tab1">
	 					<ul>	 						
							...
							<li>
								<div class="form_grid_12">
									<label class="field_title">BrainTree Merchant Account Id</label>
									<div class="form_input">
										<?php if(isset($location_details->row()->merchant_id)){echo $location_details->row()->merchant_id; }else{ echo 'Not available'; } ?>
									</div>
								</div>
							</li>	     							
							<li>

				...
				<div class="widget_content">
					...
					?>
						...
						<?php if($template_details->row()->notification_type ==='email'){ ?>
							...
							<?php } else if ($template_details->row()->notification_type ==='sms') { ?>
							 	<li>
									<div class="form_grid_12">
										<label class="field_title"><?php if ($this->lang->line('admin_notification_sms_body') != '') echo stripslashes($this->lang->line('admin_notification_sms_body')); else echo 'SMS body'; ?></label>
										<div class="form_input">
											<?php echo $template_details->row()->message['sms_body'];?>
										</div>
									</div>
								</li>
							<?php } else { ?>

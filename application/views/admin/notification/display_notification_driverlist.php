        ...
        <div id="send_sms" style="display:none;">
            ...
            <ul>
                 <li>
					...
					<input name="user_type" type="hidden"   value="driver"/>
                    <div class="form_grid_12">
                        <label class="field_title" for="media_title" style="width: 56%;"><?php if ($this->lang->line('admin_notification_choose_sms_template') != '') echo stripslashes($this->lang->line('admin_notification_choose_sms_template')); else echo 'Choose SMS Template'; ?> <span class="req">*</span></label>
                        <div class="form_input">
                          <select id="sel_sms" onchange="sendSms();" class="chzn-select1 required" name="sms_id" tabindex="1" style="width: 350px; display: none;" data-placeholder="Select Model Type">

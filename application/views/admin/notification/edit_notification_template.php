...
<?php } else if($templateDetails->notification_type == 'sms'){ ?>
<style>
.noti-mail {
	display:none;
}
				...
				<div class="widget_content">
					...
					?>
	 					<ul>
								...
								<div class="form_grid_12">
									...
									<div class="form_input">
										<select name="notification_type" id="notification_type" tabindex="1" class="required" style="height: 31px; width: 51%;">
											...
											<option value="sms" <?php if(isset($templateDetails->notification_type)) if($templateDetails->notification_type == 'sms') echo 'selected="selected"';?>><?php if ($this->lang->line('admin_notification_sms') != '') echo stripslashes($this->lang->line('admin_notification_sms')); else echo 'SMS'; ?></option>
										</select>
									</div> 
								</div>
							</li>
							...
							<li class="noti-sms">
								<div class="form_grid_12">
									<label class="field_title" for="sms_body"><?php if ($this->lang->line('admin_notification_sms_body') != '') echo stripslashes($this->lang->line('admin_notification_sms_body')); else echo 'SMS Body'; ?> <span class="req">*</span></label>
									<div class="form_input">
										<textarea name="message[sms_body]" style=" width:51%; required" class="tipTop required" title="<?php if ($this->lang->line('admin_newsletter_sms_body') != '') echo stripslashes($this->lang->line('admin_newsletter_sms_body')); else echo 'Please enter the SMS Body'; ?>"  tabindex="" maxlength="150"><?php if(isset($templateDetails->message['sms_body'])) echo $templateDetails->message['sms_body']; ?></textarea>
									</div>
								</div>
							</li>

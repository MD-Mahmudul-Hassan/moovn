						...
						<tr>
							...
							<td class="center">
								<ul class="action_list">
									<li style="width:100%;">
										<a class="p_car tipTop" href="admin/rides/assign_driver/<?php echo $rides_details->row()->ride_id;?>/<?php echo $row['_id'];?>" title="<?php if ($this->lang->line('admin_rides_assign_cab') != '') echo stripslashes($this->lang->line('admin_rides_assign_cab')); else echo 'Assign Ride'; ?>">

            ...
            <div class="text-center head_category">
                ...
                <h1 class="text-center"><?php
                    if ($this->lang->line('driver_earn_money') != '')
                        ...
                        echo 'EARN MONEY WITH YOUR VEHICLE!';
                    ?></h1>
            </div>
        </div>
    </div>
                            ...
                            <?php if (count($vehicles['vehicle_type_names']) > 0) { ?>
                                <p><?php
                                    ...
                                    if ($this->lang->line('driver_will_come') != '')
                                        ...
                                        echo 'then select this category!';
                                    ?></p>
                            <?php } else { ?>
                                <p><?php
                                    if ($this->lang->line('driver_none_of_the_vehicles') != '')
                                        ...
                                        echo 'No vehicles currently specified in this category';
                                    ?></p>
                            <?php } ?>
                    ...
                    <?php
							...
							<h2 class="text-center"><?php
                                if ($this->lang->line('no_available_catagories_location') != '')
                                    ...
                                    echo 'NO VEHICLE CATEGORIES AVAILABLE IN THIS LOCATION';
                                ?></h2>
							<?php } ?>

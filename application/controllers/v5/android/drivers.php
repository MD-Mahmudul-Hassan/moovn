	...
	* */
    ...
    public function accept_ride() {
        ...
        try {
            ...
            if ($chkValues >= 4) {
                $checkDriver = $this->driver_model->get_selected_fields(DRIVERS, array('_id' => new \MongoId($driver_id)), array('_id', 'driver_name', 'image', 'avg_review', 'email', 'dail_code', 'mobile_number', 'vehicle_number', 'vehicle_model', 'driver_commission','last_online_time'));
                if ($checkDriver->num_rows() == 1) {

...
class Rides extends MY_Controller {
    ...
    function __construct() {
        parent::__construct();
        $this->load->helper(array('cookie', 'date', 'form', 'string'));
    ...
    public function display_rides() {
        ...
        if ($this->checkLogin('A') == '') {
            ...
            if ($ride_act == 'reservations') {
                if ($this->lang->line('dash_reservations') != '') {
                    $this->data['heading']= stripslashes($this->lang->line('dash_reservations')); 
                }
                else {
                    $this->data['heading'] = 'Reservations: Booked & Accepted Rides';
                }
                ...
                if ($this->lang->line('dash_on_rides_list') != '') {
                    ...
                    $this->data['heading'] = 'On Rides List';
                }
                ...
                if ($this->lang->line('dash_completed_rides_list') != '') {
                    ...
                    $this->data['heading'] = 'Completed Rides List';
                }
                ...
                if ($this->lang->line('dash_cancelled_rides_list') != '') {
                    ...
                    $this->data['heading'] = 'Cancelled Rides List';
                }
                ...
                if ($this->lang->line('dash_rider_cancelled_rides_list') != '') {
                    ...
                    $this->data['heading'] = 'Rider Cancelled Rides List';
                }
                ...
                if ($this->lang->line('dash_driver_cancelled_rides_list') != '') {
                    ...
                    $this->data['heading'] = 'Driver Cancelled Rides List';
                }
                ...
                if ($this->lang->line('heading_expired_ride_list') != '') {
                    ...
                    $this->data['heading'] = 'Expired Rides List';
                }
            } else {
                if ($this->lang->line('dash_all_rides_list') != '') {
                    ...
                    $this->data['heading'] = 'All Rides List';
                }
            }
                ...
                if($checkRide->num_rows()>0){
                    ...
                    if ($doAction == 1) {
                        ...
                        if ($reasonVal->num_rows() > 0) {
                            ...
                            if($driver_id!=""){
                                $driverVal = $this->rides_model->get_selected_fields(DRIVERS, array('_id' => new \MongoId($driver_id)), array('fcm_token', 'device_type', 'push_notification'));
                                ...
                                if (isset($driverVal->row()->fcm_token)) {
                                    if (isset($driverVal->row()->device_type) && !empty($user['device_type'])) {
                                        $user_type = 'driver';
                            ...
                            if($user_id!=""){
                                $userVal = $this->rides_model->get_selected_fields(USERS, array('_id' => new \MongoId($user_id)), array('fcm_token', 'device_type', 'push_notification_key', 'push_type'));
                                ...
                                if (isset($userVal->row()->fcm_token)) {
                                    if (isset($userVal->row()->device_type) && !empty($user['device_type'])) {
                                        $user_type = 'rider';
    ...
    public function assign_driver() {
        if ($this->checkLogin('A') == '') {
            ...
            if ($checkRide->num_rows() == 1) {
                ...
                $driverResult = $this->driver_model->getDriver($driver_id);
                ...
                if (isset($driver->fcm_token)) {
                    $user_type = 'driver';
                    $this->notify($driver->fcm_token, $message, 'ride_later_request', $options, $driver->device_type, $user_type);
                        ...
                        if ($driver->push_notification['type'] == 'ANDROID') {
                            if (isset($driver->push_notification['key'])) {
                                if ($driver->push_notification['key'] != '') {
                                    ...
                                    $condition = array('_id' => new \MongoId($driver->_id));
                                    $this->cimongo->where($condition)->inc('req_received', 1)->update(DRIVERS);

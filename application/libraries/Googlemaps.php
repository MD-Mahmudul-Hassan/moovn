   ...
   var $adsense					= FALSE; 					// Whether Google Adsense For Content should be enabled
	...
	function create_map()
	{
		...
		if ($this->maps_loaded == 0)
		{
			...
			<script type="text/javascript" src="' . ( ($this->https) ? 'https' : 'http' ) . '://developers.google.com/maps/documentation/javascript/examples/markerclusterer/markerclusterer.js"></script>
			'; }
		}
		if ($this->jsfile=="") {
			$this->output_js .= '
